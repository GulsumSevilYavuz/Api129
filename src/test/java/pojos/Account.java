...
public class Account{
    ...
    public Account(int id, String description, int balance, String accountType, String accountStatusType, String createDate,
                   String closedDate, Object employee, Object accountlogs) {
        this.id = id;

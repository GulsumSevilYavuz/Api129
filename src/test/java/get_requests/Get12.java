...
public class Get12 extends GoRestBaseUrl {
    ...
    */
    ...
    public void get12() {
        ...
        //Do assertion
        GoRestPojo actualData = response.as(GoRestPojo.class);//Deserialization yaptik
        System.out.println("actualData = " + actualData);

        assertEquals(200, response.statusCode());
        assertEquals(expectedData.getMeta(), actualData.getMeta());
        //assertEquals(expectedData.getData().getName(),actualData.getData().getName()); böylede olur ama gerek yok
